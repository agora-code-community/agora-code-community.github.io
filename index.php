	        ...
	        <div class="container">
	            ...
	            <div class="navbar-header">
	                ...
	                <a class="navbar-brand" href="#">
                        <img class="logo-1" src="images/agora_logo_new_icon.png" alt="LOGO">
	                    <img class="logo-2" src="images/agora_logo_new_icon.png" alt="LOGO">
	                </a>
	            </div>
	            ...
	            <nav class="collapse navbar-collapse" id="navbar">
	                <ul class="nav navbar-nav navbar-right" id="top-nav">
                        ...
                        <li><a href="javascript:ajaxpage('pages/googleio/gio.php')"><img src="pages/googleio/images/io_button.png" width="26px"> Livestream</a></li>
