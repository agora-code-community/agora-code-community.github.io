...
<section id="content" class="m-t-lg wrapper-md animated fadeInDown">
    ...
    <div class="container aside-xxl">
		...
		An account has been created for you at <a href="www.agoracode.commuunity">www.agoracode.commuunity</a>.</p>';

                    $message .= '<p style="color:#080;font-size:18px;">

						<a href="http://www.agoracode.commuunity/index.php?page=member&activate&username='.$username.'&keynode='.$key.'">
				...
				<a href="http://www.agoracode.commuunity/index.php?page=member&activate&username='.$username.'&keynode='.$key.'">
						...
						http://www.agoracode.commuunity/index.php?page=member&activate&username='.$username.'&keynode='.$key.'</a></p>';

                    $message .= '<p style="color:#080;font-size:18px;"> Regards, <br/>

		Team Agora <br/>

		<a href="www.agoracode.commuunity">www.agoracode.commuunity</a>
                    ...
                    mail("agoracode@agoracode.community","Registration at Agora Code Community Website","This is just to inform you that $username has just registered on www.agoracode.commuunity");
                ...
                <div class="panel-body">
                    ...
                    <p>Welcome to the Agora Code Community!!.. Our site is still in development but Quickly signup for an account now. <br/>
                    ...
                    <form id="passwordForm" action="index.php?page=member&signup" method="post" data-validate="parsley">
                        ...
                        <p>
                            ...
                            All new passwords must contain at least 8 characters and one number (0-9).
                        ...
                        <div class="form-group">
                            ...
                            <input name="password" type="password" value="" id="password1" class="form-control" placeholder="Password"
                                   ...
                                   pattern="((?=.*\d).{8,100})" data-parsley-pattern="((?=.*\d).{6,20})" data-required="true" autocomplete="off">
