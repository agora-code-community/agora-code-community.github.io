                ...
                <aside class="col-lg-3 b-l">
                  <section class="vbox">
                    <section class="scrollable padder-v">
                      <div class="panel">
                        <h4 class="font-thin padder">Skills <a href="#" class="btn btn-xs btn-success m-t-xs pull-right">Add Skill</a></h4>
                        <ul class="list-group">
                      <li class="list-group-item">
                      php
                        <div class="progress progress-sm m-t-sm progress-striped active">
